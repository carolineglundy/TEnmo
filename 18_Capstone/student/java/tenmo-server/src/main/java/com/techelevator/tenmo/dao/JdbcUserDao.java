...
public class JdbcUserDao implements UserDao {
    ...
    @Override
    public User findUsernameByUserId(int accountId) throws UsernameNotFoundException { //may need an exception
        String sql = "SELECT users.user_id, username, password_hash " +
                "FROM users " +
